...
- Audio is analyzed using FFT
- Sound frequencies generate waveform visuals
- Volume controls the size of shapes

This creates a real-time interaction between human voice and digital visuals.
...
3. Speak, clap, or make sounds into the microphone
4. Watch the visuals react to your audio input

## Project Goal
The purpose of this project is to demonstrate dynamically parametric media where human sound directly controls visual forms. This creates a near-simultaneous exchange of information between the user and the system.
